  ...
  <DrawerContent className="bg-white flex flex-col fixed bottom-0 left-0 right-0 max-h-[96%] rounded-t-[10px]">
    ...
    <div className="p-4 pb-0">
      <div className="flex items-center justify-center gap-5">
        <div className="w-10 h-10 flex items-center justify-center bg-[#9FE870] bg-opacity-20 rounded-full cursor-pointer" onClick={()=>{getuserlocalfromxy();setMapTriggerFlyTo(!mapTriggerFlyTo)}}>
